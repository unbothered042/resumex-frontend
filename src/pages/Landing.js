    ...
    <div className="min-h-screen bg-gray-950 text-white">
      ...
      <div className="flex flex-col items-center justify-center text-center px-6 py-24">
        <h1 className="text-5xl font-bold mb-6">
          Land Your Dream Job with <span className="text-blue-400">ResumeX</span>
        </h1>
      ...
      <div className="px-6 py-16 bg-gray-900">
        <h2 className="text-3xl font-bold text-center mb-12">What ResumeX Does</h2>
      ...
      <div className="flex flex-col items-center justify-center text-center px-6 py-20">
        ...
        <p className="text-gray-400 mb-8">Join thousands of job seekers using ResumeX to land interviews faster.</p>
        <Link
          to="/register"
          className="bg-blue-500 hover:bg-blue-600 px-8 py-4 rounded-lg text-lg font-semibold transition"
        >
      ...
      <footer className="text-center text-gray-600 py-6 border-t border-gray-800">
        © 2026 ResumeX.|Created by Paul Iheabunike| All rights reserved. | <a href="/privacy" className="hover:underline">Privacy Policy</a> | <a href="/terms" className="hover:underline">Terms of Service</a>
